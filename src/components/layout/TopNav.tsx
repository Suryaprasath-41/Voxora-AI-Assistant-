    ...
    <header className="sticky top-0 z-30 w-full h-16 border-b border-white/[0.08] bg-[#080E1E] px-4 sm:px-6 lg:px-8 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3 ml-4">
        ...
        {(() => {
          ...
          const userEmail = session?.user?.email || "maddy@example.com";
          ...
          return (
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 p-1.5 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] transition-colors"
              ...
              >
                {userImage ? (
                  ...
                  <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-tr from-[#5B35F5] to-[#268CFF] text-xs font-bold text-white shadow-sm">
              ...
              {userDropdownOpen && (
                <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-[#08162B] p-2 shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-100 border border-white/15 text-slate-100">
                  ...
                  >
                    <User className="h-4 w-4 text-[#35D6FF]" />
                    Profile
                  </Link>
                  <Link
                    href="/settings"
                    ...
                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs text-slate-300 hover:text-white hover:bg-white/10 transition-colors"
                  >
                    <Settings className="h-4 w-4 text-[#5B35F5]" />
                    Settings
                  </Link>
                  <Link
                    href="/studio"
                    ...
                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs text-slate-300 hover:text-white hover:bg-white/10 transition-colors"
                  >
                    <AudioWaveform className="h-4 w-4 text-[#268CFF]" />
                    Voice Profiles
                  </Link>
                  {session?.user ? (
                    <button
                    ...
                    <Link
                      href="/login"
                      onClick={() => setUserDropdownOpen(false)}
                      className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs text-[#35D6FF] hover:bg-white/10 transition-colors mt-1 font-medium"
                    >
